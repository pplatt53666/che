...
public class ResourceApiModule extends AbstractGinModule {
    ...
    protected void configure() {
        ...
        GinMultibinder.newSetBinder(binder(), RenamingSupport.class).addBinding().to(NopsSourceRenameValidator.class);
    }

    public static class NopsSourceRenameValidator implements RenamingSupport{
